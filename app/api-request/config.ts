...
if (env === "production") {
    ...
    config.API_DOMAIN_URL = "http://192.168.191.82:4000"; // Development URL
    config.GOOGLE_API_KEY = "AIzaSyA9qviqi7tO8nndT6WAP_O5qr3NrfpILl0";
    config.SOCKET_IO_URL = "http://192.168.191.82:4000"; // Development Socket URL
}

export default config;

export const origin = env === "production" ? "https://ship.genamplifysol.com" : "http://192.168.191.82:4000";
